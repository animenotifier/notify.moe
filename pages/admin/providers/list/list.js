...
exports.get = (request, response) => {
	...
	let tasks = providers.map(provider => arn.db.filter('Match' + provider, record => !record.edited && record.similarity !== 1).then(uneditedMatches => matches[provider] = uneditedMatches))
