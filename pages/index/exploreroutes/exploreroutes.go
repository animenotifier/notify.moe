...
import (
	...
	"github.com/animenotifier/notify.moe/pages/explore/exploreanime"
...
func Register(app *aero.Application) {
	// Explore
	page.Get(app, "/explore", explore.Get)
	page.Get(app, "/explore/anime", exploreanime.Filter)
	page.Get(app, "/explore/anime/:year/:season/:status/:type", exploreanime.Filter)
